      ...
      >
        ...
        >
          ...
          <div className="flex gap-2">
            ...
            <div>
              <label className="select select-sm cursor-pointer rounded-lg">
                <span className="label  cursor-pointer">Color</span>
                <select className="w-full max-w-xs rounded-lg">
                  <option>Grey</option>
                  <option>Blue</option>
          ...
          <div className="flex gap-2">
            ...
            <label className="select select-sm cursor-pointer rounded-lg">
              ...
              <select className="w-full max-w-xs rounded-lg" defaultValue={""}>
                <option value={""} disabled >Select Project</option>
                {projects.map((project) => (
                  <option key={project._id} value={project._id}>{truncate(project.name)}</option>
                ))}
              </select>
            </label>
          </div>
