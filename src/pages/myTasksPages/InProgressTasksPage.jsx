...
import { addTasksInProgress } from "../../store/features/personalTaskSlice";
...
const InProgressTasksPage = () => {
  ...
  const { tasksInProgress } = useSelector((state) => state.personalTask);
  ...
  useEffect(() => {
    ...
    const handleGetAllTasks = async () => {
      ...
      if (res && res.success) {
        // console.log(res);
        dispatch(addTasksInProgress(res.data));
