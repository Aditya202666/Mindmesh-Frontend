...
import { addCompletedTasks } from "../../store/features/personalTaskSlice";
...
const CompletedTasksPage = () => {
  ...
  const { completedTasks } = useSelector((state) => state.personalTask);
  ...
  useEffect(() => {
    ...
    const handleGetAllTasks = async () => {
      ...
      if (res && res.success) {
        // console.log(res);
        dispatch(addCompletedTasks(res.data));
